...
<p>Este proyecto fue desarrollado como parte de mis prácticas profesionales supervisadas en la Universidad Tecnológica Nacional, para el Hospital de San Pablo. La aplicación web permite a los usuarios comunes informarse sobre noticias médicas y consultar los horarios de atención, ya que el hospital funciona con una modalidad de "orden de llegada" en lugar de turnos. Además, muestra los horarios de los centros de atención primaria (CAPS) que forman parte de la red hospitalaria.
